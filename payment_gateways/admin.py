...
@admin.register(PortmoneEasypayPayment)
class PortmoneEasypayPaymentAdmin(admin.ModelAdmin):
    list_display = (
        'order_id',
        'account',
        'amount',
...
@admin.register(PortmonePrivatPayment)
class PortmonePrivatPaymentAdmin(admin.ModelAdmin):
    list_display = (
        'transaction_id',
        'contract_num',
        'amount',
...
@admin.register(OkciPrivatPayment)
class OkciPrivatPaymentAdmin(admin.ModelAdmin):
    list_display = (
        'transaction_id',
        'contract_num',
        'amount',
...
@admin.register(OkciEasypayPayment)
class OkciEasypayPaymentAdmin(admin.ModelAdmin):
    list_display = (
        'order_id',
        'account',
        'amount',
